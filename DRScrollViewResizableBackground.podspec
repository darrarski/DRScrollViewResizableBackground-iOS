Pod::Spec.new do |s|
  ...
  s.homepage     = "https://bitbucket.org/darrarski/DRScrollViewResizableBackground-iOS.git"
  s.license      = 'MIT'
  s.author       = { "Darrarski" => "darrarski@gmail.com" }
  s.source       = { :git => "https://bitbucket.org/darrarski/DRScrollViewResizableBackground-iOS.git" }
